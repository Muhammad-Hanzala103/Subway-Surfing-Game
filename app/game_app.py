...
class GameApp:
    ...
    def __init__(self):
        ...
        self.scene_controller.register(GameState.MENU, MenuScene(self))
        self.scene_controller.register(GameState.SHOP, ShopScene(self))
        self.scene_controller.register(GameState.PLAYING, PlayScene(self))
        self.scene_controller.register(GameState.PAUSED, PauseScene(self))
        self.scene_controller.register(GameState.GAME_OVER, GameOverScene(self))
